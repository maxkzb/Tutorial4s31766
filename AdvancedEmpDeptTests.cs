...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnMinSalaryInDept30()
    {
        ...
        decimal? minSalary = emps.Where(emp => emp.Sal == 30).Min(emp => emp.Sal);
    ...
    public void ShouldReturnFirstTwoHiredEmployees()
    {
        ...
        var firstTwo = emps.OrderBy(emp => emp.Sal).Take(2).ToList(); 
    ...
    public void ShouldFindAnyWithCommissionOver400()
    {
        ...
        var result = emps.Any(emp => emp.Sal > 400 && emp.Comm != null); 
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = (from emp1 in emps join emp2 in emps on emp1.Mgr equals emp2.Mgr
                select new { Employee = emp1.EName, Manager = emp2.EName }).ToList();
